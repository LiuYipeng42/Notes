...
date: 2021-02-15 22:56:37&emsp;  
description: mysql的数据查询基础语法，查询中的排序，连接查询，完整的DQL语句&emsp;  
---&emsp;  
&emsp;  
&emsp;&emsp;&emsp;  
&emsp;  
...
##### 在对查询出的数据进行命名&emsp;  
&emsp;  
&emsp;&emsp;例如将num显示为Number&emsp;  
&emsp;  
```mysql
select num as Number from tableName;
```
&emsp;  
&emsp;&emsp;**真实的字段名并没有改变**&emsp;  
&emsp;  
&emsp;&emsp;其中 as 关键字可以省略&emsp;  
&emsp;  
&emsp;&emsp;&emsp;  
&emsp;  
#### 查看表中所有数据&emsp;  
...
```
&emsp;  
&emsp;&emsp;在条件中，若条件中有字符串，则**字符串**用**单引号**括住&emsp;  
&emsp;  
&emsp;&emsp;在数据库中**null不是一个值**，代表什么也没有，**为空**，0与null不相等&emsp;  
&emsp;  
&emsp;&emsp;当运算符**优先级不确定**时要利用**括号**来解决&emsp;  
&emsp;  
&emsp;&emsp;&emsp;  
&emsp;  
##### 运算符&emsp;  
